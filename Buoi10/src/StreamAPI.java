...
public class StreamAPI {
  ...
  static {
    students.add(new Student("Nguyen Van A", "1", 20, "Thanh Hoa"));
    students.add(new Student("Nguyen Thi B", "2", 16, "Ha noi"));
    students.add(new Student("Le Thi C", "3", 18, "Hai Phong"));
    students.add(new Student("Trinh Van B", "4", 21, "Bac Giang"));
    students.add(new Student("Tran Thi D", "5", 22, "Dong Nai"));
  }
  ...
  public static void main(String[] args) {
    ...
    //StreamAPI.Student has age >= 20 and limit 2 student
